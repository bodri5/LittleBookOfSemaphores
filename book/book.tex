...
\begin{lstlisting}[title={Extended Faneuil Hall problem hint}]{}
exit = Semaphore(0)
allGone = Semaphore(0)
\end{lstlisting}
...
\begin{lstlisting}[title={Extended Faneuil Hall problem solution (immigrant)}]{}
noJudge.wait()
enter()
entered++
noJudge.signal()
...
\newpage
\begin{lstlisting}[title={Extended Faneuil Hall problem solution (judge)}]{}
noJudge.wait()
mutex.wait()
